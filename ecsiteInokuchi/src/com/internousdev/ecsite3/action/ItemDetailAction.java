...
public class ItemDetailAction extends ActionSupport implements SessionAware{
	...
	public String execute(){
		...
		System.out.println(session.get("item_id"));
		System.out.println(session.get("item_name"));
		System.out.println(session.get("item_price"));
		System.out.println(session.get("item_stock"));
		System.out.println(session.get("insert_date"));
		System.out.println(session.get("update_date"));
