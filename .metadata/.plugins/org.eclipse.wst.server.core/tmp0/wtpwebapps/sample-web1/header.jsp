...
function goLoginAction(){
	document.getElementById("from").action="GoLoginAction";
}
function goMyPageAction(){
	document.getElementById("from").action="MyPageAction";
}
function goCartAction(){
	document.getElementById("from").action="CartAction";
}
function goProductListAction(){
	document.getElementById("categoryId").value=1;
	document.getElementById("from").action="ProductListAction";
}
function goLogoutAction(){
	document.getElementById("from").action="LogoutAction";
}
function goSearchItemAction(){
	document.getElementById("from").action="SearchItemAction";
}
</script>
</head>
<body>
