...
public class MyPageDAO {
	...
	public MyPageDTO getMyPageUserInfo(String item_transaction_id, String user_master_id)throws SQLException{
		...
		try{
			...
			preparedStatement.setDtring(1,item_transaction_id);
			preparedStatement.setDtring(2,user_master_id);
			ResultSet resultSet = preparedtatemnt.executeQUery();
	...
	public int buyItemHistoryDelete(String item_transaction_id, String user_item_id)throws SQLException{

		DBConnector dbconnector = new DBConnector();
		Connection conneciton= dbConnector.getConnection();

		String sql = "DELETE FROM user_buyItem transaction WHERE item_transaction_id = ?AND user_master_id=?";
